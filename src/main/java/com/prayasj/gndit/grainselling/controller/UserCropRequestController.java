...
public class UserCropRequestController {
    ...
    @DeleteMapping(value = "api/crop-request/{requestId}")
    public ResponseEntity<Void> deleteCropRequest(@PathVariable String requestId){
        userCropRequestService.deleteRequest(requestId);
